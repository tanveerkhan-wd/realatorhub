...
<?php 
        if(!empty($agent_id)){ ?>
    <div class="path_link">
        <a href="{{url('agency/agent')}}" class="">My Agents > </a> <a href="#" class="current_page">Leads</a>
    </div>
    <div class=""> 
          <ul class="nav nav-tabs text-center theme_tab" id="myTab" role="tablist" style="margin-bottom: 60px;">
              ...
              <li class="nav-item active">
                  <a class="nav-link active" id="designSettings-tab" href="{{url('/agency/agent/leads/'.$agent_id)}}" >Agent Leads</a>
              </li>
              <li class="nav-item">
  ...
  <div class="container-fluid">
    <div class="col-12">
    <div class="path_link">
        <a href="{{url('agency/leads')}}" class="current_page">My Leads</a>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group ">                                     
                <select name="address" class="form-control select2" required="">
      ...
      <table class="table table-hover" id="datatableData">
          <thead>
              <tr>
                  ...
                  <th>Created Date</th>
                  <th>Status</th>
                  <th><div class="action_btn_div">Action</div></th>
              </tr>
          </thead>
          <tbody>
          </tbody>
...
<script type="text/javascript" src="{{ url('public/js/common/leads/list.js') }}"></script>
<script type="text/javascript">
...
$(document).on('click','#saveNoteModelButton',function(e){
  ...
  if(formStatus==true){
        ...
        $.ajax({
                type: "POST",
                url: base_url_route+'/common/leads/addNotes',
