...
<section class="content">
    <div class="row new_added_div">
        ...
        <div class="col-md-12">
            <div class="path_link">
                <a href="{{url('admin/faqs')}}" class="parent_page">FAQS List > </a><a href="#" class="current_page">Add FAQ</a>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <form role="form" action="{{ url('admin/faqs/add') }}" method="post" id="logo-form" multipart-form-data novalidate="" enctype="multipart/form-data">
                                {{ @csrf_field() }}
                                <div class="row mt-10">
...
<script type="text/javascript" src="{{ url('public/js/admin/faq/add.js') }}"></script>
@endpush