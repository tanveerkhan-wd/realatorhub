                    ...
                    <div class="row">
                        <div class="col-md-4 ">
                            <div class="box-header">
                                <h3 class="box-title current_page">FAQS List</h3>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="form-group "> 
                                <a href="{{ url('admin/faqs/add') }}" class="btn btn-primary add-button" style="width: 100%;">Add</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript" src="{{ url('public/js/admin/faq/list.js') }}"></script>
@endpush