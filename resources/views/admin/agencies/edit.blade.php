...
<section class="content">
    <div class="row new_added_div">
        ...
        <div class="col-md-12">
            <div class="path_link">
            <a href="{{route('admin.agency.list')}}" class="parent_page">Agencies > </a><a href="#" class="current_page">Edit</a>
            </div>
            ...
            <form id="sign_up_form" method="POST" action="{{route('admin.agency.edit.profile')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="email" class="" id="changeEmailButton">Email ID <i class="fa fa-edit"></i></label>
...
$(document).on('click','#changeEmailModelButton',function(e){
  ...
  if(formStatus==true){
    ...
    swal({
            text: "Are you sure you want to chnage email",
            type: 'info',
            ...
            if (isConfirm.value == true) {                
                $.ajax({
                    type: "POST",
                    url: '{{route('admin.agency.change.email')}}',
                    data:{email:email,id:uid},
                    headers: {
...
$("#chnage_email_form").validate({
        rules: {
            email:{
                ...
                email: true,
                remote: {
                    url: '{{route("admin.agency.check.email")}}',
                    data:{id:'{{$agency_data->id}}'},
                    type: "get"
                }
            },
        },
...
<script type="text/javascript" src="{{ url('public/js/agency/signup/edit_agency.js') }}"></script>
