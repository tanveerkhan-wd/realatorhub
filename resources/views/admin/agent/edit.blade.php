...
<section class="content">
    <div class="row new_added_div">
        ...
        <div class="col-md-12">
            <div class="path_link">
                    <a href="#" class="parent_page">Agent > </a><a href="#" class="current_page">Edit</a>
            </div>
            ...
            <div class="row">
                    <form id="sign_up_form" method="POST" action="{{ route('admin.agency.agent.update') }}" enctype="multipart/form-data">
                        {{ @csrf_field() }}	
                        <div class="row">
        ...
        if (formStatus == true) {
            ...
            swal({
                ...
                if (isConfirm.value == true) {
                    $.ajax({
                        type: "POST",
                        url: '{{route('admin.agency.agent.change.mail')}}',
