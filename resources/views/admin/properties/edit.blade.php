...
<div class="container-fluid">
    <div class="path_link">
        <a href="{{route('admin.property.list')}}" class="parent_page">Property > </a><a href="#" class="current_page">Edit Property</a>
    </div>
    <div class="row">
        <div class="col-lg-12">	
            <form method="POST" id="property_form" action="{{route('admin.property.update',$property->id)}}" enctype="multipart/form-data">
                {{ @csrf_field() }}
                <ul class="nav nav-tabs text-center property_ul step_tab">
                    <li><a data-toggle="tab" href="#purpose">Purpose & Property Type</a></li>
                ...
                <div class="tab-content step_tab_content">
                    <div id="purpose" class="tab-pane fade in">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div id="industrail_family">
                                    ...
                                    <div class="form-row">
                                        <div class="col-6">
                                        <input type="text" class="form-control" name="zoning_industrail" id="industrail_zoning" value='{{$property->zoning}}'>
                                        <div id="pt_industrail_zoning_validate"></div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="squar_file_box">
                                        <?php if (isset($property->main_image) && !empty($property->main_image)) { ?>
                                            <img src="{{ url('public/uploads/properties_images').'/'.$property->id.'/'.$property->main_image}}" id="agency_logo_image">
                                        <?php } else { ?> 
                                            <div class="text-center">
                                                <img src="{{ url('public/assets/')}}/images/ic_sad_emoji.png" id="agency_logo_image">
                                            </div>
                                        <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='multi_img_wrap'>
                                        <div class="squar_file_box_add clearfix">
                                            <button class="btn btn-primary img_add_more" type="button">Add Image</button>
                                            <div class="squar_file_box">
                                        ...
                                        <?php if (isset($other_image) && !empty($other_image)) { ?>
                                            ...
                                            <div class="squar_file_box_add clearfix">
                                                ...
                                                <div class="squar_file_box">
                                                     <img src="{{ url('public/uploads/properties_images').'/'.$property->id.'/'.$other_img->image_name}}" class="other_img_{{$other_img->id}}">
                                                </div>
                                            </div>
                                            @endforeach
                                        <?php } ?>
                                    ...
                                    <div class='youtube_link_wrap'>
                                        <div class='row'>
                                            ...
                                            <div class="col-xs-4 col-md-2">
                                                <button class="btn btn-primary list_add_button btn-color small_btn" type="button">Add Video</button>
                                            </div>
                                        ...
                                        <div class='row'>
                                            <div class="col-xs-8 col-md-10">
                                                <div class='row'>
                                                    <div class="form-group col-md-4">
                                                        <select class="form-control dropdown_control" name="youtube_link">
                                                            <option value="1">Youtube Link</option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class='row'>
                                            <div class="col-xs-8 col-md-10">
                                                <div class='row'>
                                                    <div class="form-group col-md-4">
                                                        <select class="form-control dropdown_control" name="upload_type">
                                                            <option value="2">Upload</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-8">
...
<script type="text/javascript">
                                            ...
                                            $('.remove_img').click(function() {
                                                ...
                                                swal({
                                                    ...
                                                    if (isConfirm.value == true) {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: '{{route("admin.property.delete.image")}}',
                                        ...
                                        $('.list_add_button').click(function() {
                                            var newHtml = "<div class='row'><div class='col-xs-8 col-md-10'><div class='row'><div class='form-group col-md-4'><select class='form-control video_type_sel'><option value='1'>Youtube Link</option><option value='2'>Upload</option></select></div><div class='form-group col-md-8 video_input_div'><input autocomplete='off' name='youtube_new[]' type='url' placeholder='Youtube Link' class='form-control youtube_valid_url youtube_div'/></div></div></div><div class='col-xs-4 col-md-2'><button class='btn btn-danger small_btn list_remove_btn' type='button'>Remove Video</button></div></div></div>";
                                            ...
                                            if (typeof remove_id !== '' && typeof remove_id !== 'undefined') {
                                                swal({
                                                    ...
                                                    if (isConfirm.value == true) {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: '{{route("admin.property.delete.video")}}',
