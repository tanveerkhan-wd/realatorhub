...
@section('content')
<!-- 
View File for  Edit Blog Category
@package    Laravel
@subpackage View
@since      1.0
 -->	
...
<!-- Content Body -->
    ...
    <section class="content">
        <div class="row new_added_div">
            ...
            <div class="col-md-12">
                <div class="path_link">
                    <a href="{{url('admin/blog-post-category')}}" class="parent_page">Blog Category > </a><a href="#" class="current_page">Edit Blog Category</a>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <form role="form" action="{{ url('admin/blog-post-category/edit/'.$data['id']) }}" method="post" id="logo-form" novalidate="" enctype="multipart/form-data">
                                    {{ @csrf_field() }}
                                    <div class="row mt-10">
                                        <div class="form-group ">
                                            ...
                                            <input required="" class="form-control" value="{{ $data['title'] }}" type="text" name="title"> 
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <select name="status" class="form-control select2" required="">
                                                ...
                                                <option @if($data['status'] == 'Active')
                                                    selected="selected" 
                                                    @endif value="1">Active</option>
                                                    <option @if($data['status'] == 'Inactive')
                                                    selected="selected" 
