                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box-header">
                                <h3 class="box-title current_page">Blog List</h3>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4">
                          ...
                          <div class="col-md-2 col-sm-4">
                            <div class="serach-button-container">
                              <div class="form-group ">  
                                  <a href="{{ url('admin/blog-post/add') }}" class="btn btn-primary add-button" style="width: 100%;">Add</a>
                              </div>
                            </div>
                          </div>
                    </div>
...
<script type="text/javascript" src="{{ url('public/js/admin/blog_post/list.js') }}"></script>
@endpush