...
<!-- Content Body -->
    <section class="content">
        <div class="row new_added_div">
            ...
            <div class="col-md-12">
                <div class="path_link">
                    <a href="{{url('admin/blog-post')}}" class="parent_page">Blog List > </a><a href="#" class="current_page">Add Blog</a>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <form role="form" action="{{ url('admin/blog-post/add') }}" method="post" id="logo-form"  enctype="multipart/form-data" data-parsley-validate>
                                    {{ @csrf_field() }}
                                    <div class="row mt-10">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input onchange="readURL(this);" required="" class="form-control" type="file" name="blog_image" data-id="blog_image" id="blog_image" accept="image/*"> 
                                            <div class="errorImage"></div>
                                            <div id="blog_image_validate"></div>
                                            <img id="blog_image_img_url" src="{{ url('/public/uploads/user_profile/user.png')  }}" alt="your image"  width="auto" style="max-width:100%;"/>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <textarea class="form-control" name="descripition" id="descripition"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input required="" class="form-control" type="text" name="seo_title"> 
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input required="" class="form-control" type="text" name="seo_description"> 
...
<script type="text/javascript" src="{{ url('public/js/admin/blog_post/add.js') }}"></script>
