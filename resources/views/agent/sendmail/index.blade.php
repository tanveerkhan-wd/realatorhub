...
<div class="container-fluid">
    ...
    <form method="post" action="" class="agent_form">
        ...
        <div id="general_email_div"> 
            ...
            <div class="form-group text-center two_btns">
                ...
                <a href="{{route('agent.home')}}" class="auth_btn theme-btn grey_btn btn-text btn-size save_home_banner_data" id="prv_seo_btn">Cancel</a>
            </div>
        </div>
        <div id="fav_email_div">
            <div class="table_divide">
                <div class="table_header_bar">
                    <div class="form-row align-items-center">
                        <div class="col-sm-12 col-md-5 col-lg-5"><h5 class="table_title">Select Customers</h5></div>
    ...
    <script type="text/javascript">
        var agent_table = $('#datatableData').DataTable({
            ...
            ajax: {
                url: '{{route("agent.send.mail.customer.list.ajax")}}',
                type: 'post',
        ...
        var table = $('#property-tabel').DataTable({
            ...
            ajax: {
                url: '{{route("agent.send.mail.property.list.ajax")}}',
                type: 'post',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: function(d) {
...
//                    });
                ...
                $.ajax({
                    type: "POST",
                    url: '{{route("agent.send.general.email")}}',
