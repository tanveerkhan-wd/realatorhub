                ...
                <div class="white_box auth_box">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form action="{{ url('agency/login') }}" method="post" id="loginForm" name="loginForm">
                                {{ csrf_field() }}
