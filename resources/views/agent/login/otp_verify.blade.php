                ...
                <div class="white_box auth_box">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form action="{{ url('agency/otpverifyPost') }}" method="post" id="loginForm" name="loginForm">
                                {{ csrf_field() }}
                                ...
                                <div class="text-center two_btns">
                                    <a href="{{ url('agency/forgotPass') }}" class="theme-btn btn-color btn-text btn-size auth_btn">Back</a>
                                    <button type="submit" class="theme-btn btn-color btn-text btn-size auth_btn">Submit</button>
                                </div>
                                <div class="bottom-link text-center">
                                    <p>Already have an account?<a href="{{ url('agency/login') }}">
                                     Login</a></p>
                                </div> 
                            </form>
                        </div>
