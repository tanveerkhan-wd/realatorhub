...
<div class="container-fluid">
    <div class="path_link">
        <a href="{{route('agent.property.list')}}" class="parent_page">Property > </a><a href="#" class="current_page">Edit Property</a>
    </div>
    <div class="row">
        <div class="col-lg-12">	
            <form method="POST" id="property_form" action="{{route('agent.property.update',$property->id)}}" enctype="multipart/form-data">
                {{ @csrf_field() }}
                                            ...
                                            $('.remove_img').click(function() {
                                                ...
                                                swal({
                                                    ...
                                                    if (isConfirm.value == true) {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: '{{route("agent.property.delete.image")}}',
                                            ...
                                            if (typeof remove_id !== '' && typeof remove_id !== 'undefined') {
                                                swal({
                                                    ...
                                                    if (isConfirm.value == true) {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: '{{route("agent.property.delete.video")}}',
