...
<div class="fix_header">
    <section class="section grey_bg">
        <div class="container-fluid path_link_container">
            <div class="path_link">
                <a href="#" >Personal Information > </a><a href="#" class="current_page">Verify Email > </a><a href="#" class="">Select Subscription</a>
            </div>
        </div>
                    ...
                    <div class="white_box auth_box">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form method="POST" action="{{ route('signup.email_verification') }}" enctype="multipart/form-data" id="verificationForm" name="verificationForm">
                                    @csrf
...
<script type="text/javascript" src="{{ url('public/js/agency/signup/email_verification.js') }}"></script>
@endpush