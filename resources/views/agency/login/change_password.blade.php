                ...
                <div class="white_box auth_box">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form action="{{ url('agency/changePasswordPost') }}" method="post" id="loginForm" name="loginForm">
                                {{ csrf_field() }}
                                ...
                                $agentid=$id
                                @endphp
                                <input type="hidden" name="user_id_agent" id="user_id_agent" value="{{$agentid}}">
                                ...
                                <div class="bottom-link text-center">
                                    <p>Alredy have account?<a href="{{ url('agency/login') }}">Login</a></p>
                                </div> 
                            </form>
                        </div>
                        <div class="col-lg-3"></div>
