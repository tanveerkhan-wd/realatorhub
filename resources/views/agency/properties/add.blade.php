...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">	
            <form method="POST" id="property_form" action="{{route('agency.property.store')}}" enctype="multipart/form-data">
                {{ @csrf_field() }}
                ...
                <div class="tab-content step_tab_content">
                    ...
                    <div id="purpose" class="tab-pane fade show active">
                        <div class="row">
...
<!--                                        <div>
                                            <label class="radio-inline"><input type="radio" name="address_type" checked value="1" class="chk_radio">From Google</label>
                                            <label class="radio-inline"><input type="radio" name="address_type" value="2" class="chk_radio">Manual</label>
                                        </div>-->
                                    <div class="form-group">
                                        <div class="form-check custom_check_div w-auto">
...
<!--                                        <input type="text" id="address-input" name="address_address" class="form-control map-input" placeholder="Search Postal Code">
                    ...
                    <div id="seo_setting" class="tab-pane fade">
                        <div class="row">
                            <div class="col-lg-2"></div>
                            <div class="col-lg-8">
                                <div class="form-group">
                                                    ...
                                                    $(document).ready(function() {
                                                        ...
                                                        $('#nxt_details_btn').click(function() {
                                                            ...
                                                            if (type == '4') {
                                                                ...
                                                                if (industrial_space == '') {
                                                                    $('#pt_industrial_space_validate').text('Please Enter Space');
                                                                    return false;
                                                                }
                                                        ...
                                                        $('#nxt_address_btn').click(function() {
                                                            ...
                                                            $('.property_tab4').removeClass("disabled");
