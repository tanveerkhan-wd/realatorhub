...
<div class="container-fluid">
    <div class="row">
        <div class="col-6">
            <div class="path_link">
                <a href="{{route('agency.property.list')}}" class="current_page">My Properties </a>
            </div>
        </div>
        <div class="col-6 text-right">
            <a href="{{route('agency.property.add')}}" class="theme-btn btn-color btn-text btn-size mb-2 add_btn">Add New</a>
        </div>
    </div>
                ...
                <div class="form-row">
                    <div class="col-md-2 col-sm-6">
                        <div class="form-group "> 
                            <!-- <label>Agent</label> -->
                            <select name="agent" class="form-control select2 dropdown_control" required="">
...
<script type="text/javascript">
    var table = $('#property-tabel').DataTable({
        ...
        ajax: {
            url: '{{route("agency.property.datatable.list")}}',
            type: 'post',
