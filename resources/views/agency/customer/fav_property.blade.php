...
@section('title','Customer Favourite Properties')
@section('content')
<!-- 
    ...
    <div class="row">
        <div class="col-lg-12">	
            <ul class="nav nav-tabs text-center theme_tab" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" id="agentProperty-tab" href="{{route('agency.customer.view',$id)}}">Profile</a>
                </li>
                
                <li class="nav-item active">
                    <a class="nav-link active" id="contactForm-tab" data-toggle="tab" href="#contactForm" role="tab" aria-controls="contactForm" aria-selected="false">Favourite Properties</a>
                </li>
            </ul>
...
<script type="text/javascript">
    var table = $('#property-tabel').DataTable({
        ...
        ajax: {
            url: '{{route("agency.customer.fav.property.list")}}',
            type: 'post',
...
$(document).on('click','.deleteData',function(){
    ...
    swal({
            text: 'Are you sure you want to remove this property from favourite?',
            type: 'info',
            showCancelButton: true,
            confirmButtonClass: 'blue_button alert_btn mr-40',
            cancelButtonClass: 'blue_border_button alert_btn',
            ...
            if (isConfirm.value == true) {  
                ...
                $.ajax({
                    ...
                    data:{propertyId:propertyId,userid : '{{$id}}'},
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    success: function (data) {
