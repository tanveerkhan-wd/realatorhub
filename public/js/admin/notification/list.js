...
*/
// For Datatable
var baseModule =base_url+'/admin';
var prefixModule = base_url + '/admin/notifications/',
    ...
    aoColumnDefs: [       
        ...
        },
        {
            "mRender": function (data, type, row) {
                ...
                html += '<tr>';
                html += '<a href="' + prefixModule +row.n_id+'/delete" class="deleteData btn btn-danger btn-sm" style="color: red;padding: 5px 10px;" title="Delete" "><i class="fa fa-trash-o"></i></a>&nbsp;&nbsp;';
